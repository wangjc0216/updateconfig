...
import (
	...
	pb2 "github.com/hyperledger/fabric/protos/peer"
...
func (rc *Client) QueryInstalledChaincodes(options ...RequestOption) (*pb2.ChaincodeQueryResponse, error) {
...
func (rc *Client) QueryInstantiatedChaincodes(channelID string, options ...RequestOption) (*pb2.ChaincodeQueryResponse, error) {
...
func (rc *Client) QueryChannels(options ...RequestOption) (*pb2.ChannelQueryResponse, error) {
...
func (rc *Client) sendTransactionAndCheckEvent(eventService fab.EventService, tp *fab.TransactionProposal, txProposalResponse []*fab.TransactionProposalResponse,
	...
	case txStatus := <-statusNotifier:
		if txStatus.TxValidationCode == pb2.TxValidationCode_VALID {
...
func checkRequiredCCProposalParams(channelID string, req *InstantiateCCRequest) error {
	...
	if req.Lang == 0 || pb2.ChaincodeSpec_Type_name[int32(req.Lang)] == "" {
		req.Lang = pb2.ChaincodeSpec_GOLANG
	}
